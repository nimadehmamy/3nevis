...
var scale = 3;
var nodesize = .4;
var edgethickness = 1.4;//0.4;
var edgesegments = 20; //10;
var cam_speed = 0.1;
var cam_loc= 5;
...
for (i in nodes_loc){
  var s = scale;
  var nl = nodes_loc[i]
  nodes_loc[i] = [s*nl[0],s*nl[1],s*nl[2]];
}
...
var nodes   = network.get_nodes(nodes_loc, center = true, sizes = degrees);//);//false );// , sizes = degrees);
